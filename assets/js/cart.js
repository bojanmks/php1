$(document).ready(function() {
    ...
    function printTotalPrice() {
        ...
        $('#totalPrice').html(`Total Price: <span class="bold">${totalPrice}€</span>`).attr('data-price', totalPrice);
    }
    ...
    $('#btnCheckout').click(function() {
        if($('.cartItem').length != 0) {
            ...
            if(noErrors) {
                ajaxCallback('assets/php/forms/checkout-form-validation.php', 'post', function(output) {
